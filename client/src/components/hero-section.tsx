  ...
  return (
    <section id="home" className="pt-16 min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-chart-2/10 rounded-full"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.3, 0.6, 0.3],
          }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        >
          ...
          >
            Full Stack Developer & UI/UX Designer creating digital experiences that make a difference
          </motion.p>
